...
//   const [qrSelectedChain, setQrSelectedChain] = useState<Chain>(chains[0]);
...
//             setDynamicAmount(Math.floor(data.amount));
//           } else if (data && typeof data.amount === 'string') {
//             setDynamicAmount(Math.floor(Number(data.amount)));
//           }
//         })
//         .catch(() => setDynamicAmount(null));
//     }
//   }, [requestId]);
...
//                 >
//                   <motion.div 
//                     className={`mx-auto bg-white rounded-xl flex items-center justify-center mb-4 cursor-pointer transition-all duration-300 ${
//                       qrZoomed ? 'w-64 h-64' : 'w-48 h-48'
//                     }`}
...
//                       <QrCode className={`text-gray-800 mx-auto mb-2 transition-all duration-300 ${
//                         qrZoomed ? 'w-32 h-32' : 'w-24 h-24'
//                       }`} />
//                       <div className={`text-gray-600 font-medium transition-all duration-300 ${
//                         qrZoomed ? 'text-base' : 'text-sm'
//                       }`}>{qrSelectedChain.name}</div>
//                       <div className={`text-gray-500 transition-all duration-300 ${
//                         qrZoomed ? 'text-sm' : 'text-xs'
//                       }`}>{requestAmount} USDC</div>
//                     </div>
//                   </motion.div>
